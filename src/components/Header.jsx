...
const Header = () => {
    ...
    return (
        ...
        >
            <motion.div
                className='text-gray-600 dark:text-gray-300 inline-flex items-center gap-2 bg-white dark:bg-gray-800 px-6 py-1 rounded-full border border-gray-300 dark:border-gray-600'
            ...
            <motion.p
                className='text-center max-w-xl mx-auto mt-5 text-gray-700 dark:text-gray-300'
            ...
            <motion.button
                className='sm:text-lg text-white bg-black dark:bg-white dark:text-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors'
