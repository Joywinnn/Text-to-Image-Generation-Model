...
const Steps = () => {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-3xl sm:text-4xl font-semibold mb-2 text-gray-900 dark:text-white">
        How it works
      </h1>
      ...
      <div className="space-y-4 w-full max-w-3xl text-sm" >
        {stepsData.map((item, index) => (
          <div key={index} className="flex items-center gap-4 p-5 px-8 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 cursor-pointer hover:scale-[1.02] transition-all duration-300" >
